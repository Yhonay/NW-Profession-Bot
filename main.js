...
function addProfile(profession, profile, base){
    ...
    definedTask["Jewelcrafting"] = {
        ...
        profiles: [{
            ...
            level: {
                ...
                7: ["Jewelcrafting_Tier1_Neck_Misc_1", "Jewelcrafting_Tier2_Waist_Offense_2", "Jewelcrafting_Tier2_Refine_Basic", "Jewelcrafting_Tier2_Gather_Basic", "Jewelcrafting_Tier1_Gather_Basic"],
                8: ["Jewelcrafting_Tier1_Neck_Misc_1", "Jewelcrafting_Tier2_Waist_Offense_2", "Jewelcrafting_Tier2_Refine_Basic", "Jewelcrafting_Tier2_Gather_Basic", "Jewelcrafting_Tier1_Gather_Basic"],
                ...
                10: ["Jewelcrafting_Tier2_Neck_Offense_2", "Jewelcrafting_Tier2_Waist_Misc_2", "Jewelcrafting_Tier2_Neck_Offense_2", "Jewelcrafting_Tier2_Refine_Basic", "Jewelcrafting_Tier2_Gather_Basic", "Jewelcrafting_Tier1_Gather_Basic"],
                11: ["Jewelcrafting_Tier2_Neck_Offense_2", "Jewelcrafting_Tier2_Waist_Misc_2", "Jewelcrafting_Tier2_Neck_Offense_2", "Jewelcrafting_Tier2_Refine_Basic", "Jewelcrafting_Tier2_Gather_Basic", "Jewelcrafting_Tier1_Gather_Basic"],
                12: ["Jewelcrafting_Tier2_Neck_Offense_2", "Jewelcrafting_Tier2_Waist_Misc_2", "Jewelcrafting_Tier2_Neck_Offense_2", "Jewelcrafting_Tier2_Refine_Basic", "Jewelcrafting_Tier2_Gather_Basic", "Jewelcrafting_Tier1_Gather_Basic"],
                ...
                14: ["Jewelcrafting_Tier2_Neck_Misc_2", "Jewelcrafting_Tier3_Waist_Offense_3", "Jewelcrafting_Tier3_Refine_Basic", "Jewelcrafting_Tier3_Gather_Basic", "Jewelcrafting_Tier2_Gather_Basic", "Jewelcrafting_Tier1_Gather_Basic"],
                15: ["Jewelcrafting_Tier2_Neck_Misc_2", "Jewelcrafting_Tier3_Waist_Offense_3", "Jewelcrafting_Tier3_Refine_Basic", "Jewelcrafting_Tier3_Gather_Basic", "Jewelcrafting_Tier2_Gather_Basic", "Jewelcrafting_Tier1_Gather_Basic"],
    ...
    definedTask["Artificing"] = {
        ...
        profiles: [{
            ...
            level: {
                ...
                8: ["Artificing_Tier2_Pactblade_Temptation_3", "Artificing_Tier2_Icon_Virtuous_3", "Artificing_Tier2_Refine_Basic", "Artificing_Tier1_Gather_Basic"],
                9: ["Artificing_Tier2_Pactblade_Temptation_3", "Artificing_Tier2_Icon_Virtuous_3", "Artificing_Tier2_Refine_Basic", "Artificing_Tier1_Gather_Basic"],
                10: ["Artificing_Tier2_Pactblade_Temptation_3", "Artificing_Tier2_Icon_Virtuous_3", "Artificing_Tier2_Refine_Basic", "Artificing_Tier1_Gather_Basic"],
                11: ["Artificing_Tier2_Pactblade_Temptation_3", "Artificing_Tier2_Icon_Virtuous_3", "Artificing_Tier2_Refine_Basic", "Artificing_Tier1_Gather_Basic"],
                12: ["Artificing_Tier2_Pactblade_Temptation_3", "Artificing_Tier2_Icon_Virtuous_3", "Artificing_Tier2_Refine_Basic", "Artificing_Tier1_Gather_Basic"],
                13: ["Artificing_Tier2_Pactblade_Temptation_3", "Artificing_Tier2_Icon_Virtuous_3", "Artificing_Tier2_Refine_Basic", "Artificing_Tier1_Gather_Basic"],
    ...
    addProfile("Alchemy", {
        profileName: "Silver & Yellow Vitriol",
        isProfileActive: true,
        level: {
    ...
    addProfile("Alchemy", {
        profileName: "Red & Emerald Vitriol",
        isProfileActive: true,
        level: {
            14: ["Alchemy_Tier3_Refine_Basic", "Alchemy_Tier3_Gather_Components"],
            15: "+25",
        },
    });

    addProfile("Alchemy", {
        profileName: "Orange & Purple Vitriol",
        isProfileActive: true,
        level: {
    ...
    var defaultTrackResources = [{
        ...
        fname: 'Tome of Experience (Account)',
    ...
    function addTranslation() {
        ...
        translation = {
            ...
            'pl': {
                ...
                //'settings.main.paused.tooltip': 'WyÅÄcz wszelkÄ automatyzacjÄ',
                'settings.main.debug': 'WÅÄcz debugowanie',
                'settings.main.debug.tooltip': 'WyÅwietl wszystkie komunikaty na konsoli (Ctrl+Shift+i w Chrome/Chromium)',
                'settings.main.autoreload': 'Automatyczne przeÅadowanie',
                'settings.main.autoreload.tooltip': 'WÅÄczenie tej opcji powoduje okresowe przeÅadowanie strony (Upewnij siÄ, Å¼e Automatyczne logowanie jest wÅÄczone)',
                'settings.main.incdelay': 'ZwiÄksz opÃ³Å¼nienia skryptu o...',
                'settings.main.incdelay.tooltip': 'ZwiÄkszenie opÃ³ÅºnieÅ, gdy skrypt czeka przed prÃ³bÄ dziaÅania (pomocne przy wolnych poÅÄczeniach).',
                'settings.main.language': 'JÄzyk skryptu',
                'settings.main.language.tooltip': 'JÄzyk interfejsu tego skryptu (zmiana wymaga przeÅadowania strony)',
                'settings.main.autologin': 'PrÃ³buj logowaÄ automatycznie',
                'settings.main.autologin.tooltip': 'PrÃ³buj logowaÄ automatycznie do strony gateway',
                'settings.main.nw_username': 'Nazwa uÅ¼ytkownika Neverwinter',
                'settings.main.nw_username.tooltip': '',
                'settings.main.nw_password': 'HasÅo do Neverwinter',
                'settings.main.nw_password.tooltip': '',
                'settings.main.savenexttime': 'Zapisuj czas nastÄpnego zadania',
                'settings.main.savenexttime.tooltip': 'Zapisuj czas nastÄpnego zadania w danych miÄdzysesyjnych',
                'settings.general.openrewards': 'Otwieraj skrzynki',
                'settings.general.openrewards.tooltip': 'Otwieraj skrzynki z zadaÅ PrzywÃ³dztwa przy zmianie postaci',
                'settings.general.openInvocation': 'Otwieraj nagrody z inwokacji',
                'settings.general.openInvocation.tooltip': 'Otwieraj nagrody z inwokacji - zajmujÄ masÄ miejsca, bo siÄ nie ÅÄczÄ w stosy',
                'settings.general.openVIP': 'Otwórz rachunek Zwiazany Nagrody VIP',
                ...
                'settings.general.keepOneUnopened': 'Pozostaw jednÄ skrzynkÄ nieotwartÄ',
                ...
                'settings.general.refinead.tooltip': 'Przy zmianie postaci szlifuj diamenty astralne jeÅli to moÅ¼liwe',
                'settings.general.runSCA': 'Uruchom WybrzeÅ¼e Mieczy',
                'settings.general.runSCA.tooltip': 'Uruchom WybrzeÅ¼e Mieczy po wybraniu zadaÅ profesji',
                'settings.profession.fillOptionals': 'WypeÅniaj opcjonalnych pracownikÃ³w',
                'settings.profession.fillOptionals.tooltip': 'PozwÃ³l na uÅ¼ywanie wiÄkszej iloÅci pracownikÃ³w dla zadaÅ, ktÃ³re na to pozwalajÄ',
                'settings.profession.autoPurchase': 'Autozakup surowcÃ³w',
                'settings.profession.autoPurchase.tooltip': 'Automatycznie kupuj wynagane surowce profesji ze sklepu (po 100 sztuk rÃ³wnoczeÅnie)',
                'settings.profession.trainAssets': 'Trenuj pracownikÃ³w',
                'settings.profession.trainAssets.tooltip': 'PozwÃ³l na trenowanie/ulepszanie zwykÅych pracownikÃ³w',
                'settings.profession.spreadLeadership': 'Inteligentny przydziaÅ pracownikÃ³w do PrzywÃ³dztwa',
                'settings.profession.spreadLeadership.tooltip': 'PrÃ³buje przydzieliÄ jak najmniej zwykÅych pracownikÃ³w do zadaÅ przywÃ³dztwa',
                'settings.profession.stopNotLeadership': 'Wstrzymaj profesje inne od PrzywÃ³dztwa na poziomie',
                'settings.profession.stopNotLeadership.tooltip': 'Nie uruchamiaj zadaÅ profesji innej od PrzywÃ³dztwa po osiÄgniÄciu poziomu. Upewnij siÄ, ze masz ustawione PrzywÃ³dztwo.',
                'settings.profession.stopAlchemyAt3': 'Wstrzymaj naukÄ Alchemii na poziomie 3',
                'settings.profession.stopAlchemyAt3.tooltip': 'Wstrzymaj naukÄ Alchemii na poziomie 3 lub wyÅ¼szym. Upewnij siÄ, Å¼e masz ustawione inne profesje.',
                'settings.consolid.consolidate': 'Konsoliduj AD przez ZAX',
                'settings.consolid.consolidate.tooltip': 'Automatycznie prÃ³buj wysyÅaÄ Diamenty Astralne przez wymianÄ ZEN i wypÅacaÄ na jednej postaci',
                'settings.consolid.bankerName': 'Nazwa Bankiera',
                'settings.consolid.bankerName.tooltip': 'WprowadÅº nazwÄ postaci, ktÃ³ra ma zbieraÄ wszystkie Diamenty Astralne konta',
                'settings.consolid.minToTransfer': 'Min AD do transferowania',
                'settings.consolid.minToTransfer.tooltip': 'Minimalna iloÅÄ DiamentÃ³w Astralnych, przy ktÃ³rej nastÄpi prÃ³ba przeniesienia do bankiera',
                'settings.consolid.minCharBalance': 'Min AD do pozostawienia',
                'settings.consolid.minCharBalance.tooltip': 'Minimalna iloÅÄ DiamentÃ³w Astralnych, ktÃ³re powinny pozostaÄ na koncie postaci',
                'settings.consolid.transferRate': 'Stawka AD za Zen',
                'settings.consolid.transferRate.tooltip': 'DomyÅlna stawka DiamentÃ³w Astralnych za ZEN uÅ¼yta do transferowania',
            },
            'fr': {
                'translation.needed': 'traduction nÃ©cessaire',
           }
        };
    }
